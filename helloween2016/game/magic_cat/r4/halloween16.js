(function() {
    ...
    ha(Qe, Ke);
    var Pe = [{
            filename: "game/magic_cat/cta-png-sprite.png",
            size: [217, 80]
        }, {
            filename: "game/magic_cat/main-png-sprite.png",
            size: [1381, 1467]
        }, {
            filename: "game/magic_cat/level1-png-sprite.png",
            size: [3617, 820]
        }, {
            filename: "game/magic_cat/level1-png1-sprite.png",
            size: [717, 295]
        }, {
            filename: "game/magic_cat/level1-jpg-sprite.png",
            size: [1283, 360]
        }, {
            filename: "game/magic_cat/gameover-png-sprite.png",
            size: [441, 119]
        }, {
            filename: "game/magic_cat/level2-png-sprite.png",
            size: [5929, 378]
        }, {
            filename: "game/magic_cat/level2-jpg-sprite.png",
            size: [640, 360]
        }, {
            filename: "game/magic_cat/level3-png-sprite.png",
            size: [2458, 779]
        }, {
            filename: "game/magic_cat/level3-jpg-sprite.png",
            size: [640, 360]
        }, {
            filename: "game/magic_cat/level4-png-sprite.png",
            size: [5586, 393]
        }, {
            filename: "game/magic_cat/level4-jpg-sprite.png",
            size: [640, 360]
        }, {
            filename: "game/magic_cat/level5-png-sprite.png",
            size: [1251, 1710]
        }, {
            filename: "game/magic_cat/level5-png1-sprite.png",
            size: [4187, 723]
        }, {
            filename: "game/magic_cat/level5-png2-sprite.png",
            size: [2566, 1165]
        }, {
            filename: "game/magic_cat/level5-png3-sprite.png",
            size: [4035, 360]
        }, {
            filename: "game/magic_cat/level5-jpg-sprite.jpg",
            size: [2703, 1069]
        }, {
            filename: "game/magic_cat/end-png-sprite.png",
            size: [2360, 1244]
        }, {
            filename: "game/magic_cat/end-png1-sprite.png",
            size: [2428, 183]
        }, {
            filename: "game/magic_cat/end-jpg-sprite.png",
            size: [640, 360]
        }, {
            filename: "game/magic_cat/main-jpg-sprite.jpg",
            size: [1283, 280]
        }],
    ...
    var Yo = yj.$(),
        Zo = function(a, b, c) {
            ...
            this.W = Dm(a, ei, fi, function() {
                var e = Vo(),
                    f = Wo(d.o);
                Ae() || (e = To(e), (new Ro(e, window.google.doodle.alt || "", f, "logos/2016/halloween16/share.png")).s())
            }, L("Share - G+"));
